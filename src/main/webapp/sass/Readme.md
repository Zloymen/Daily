...
folder are mapped to the application's root namespace, 'ExtJS5Diary'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "ExtJS5Diary"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'ExtJS5Diary' in the same way
as `"ExtJS5Diary/sass/src"`.
